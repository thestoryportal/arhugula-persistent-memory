...
**Sweep verdict file:** `/workspace/archive/stale_subdirs/stage_2_sweep/sweep_verdict.json` (analogous to Stage 1 `aggregate_verdict.json`; one entry per configuration plus an aggregate `sweep_pass` boolean).
