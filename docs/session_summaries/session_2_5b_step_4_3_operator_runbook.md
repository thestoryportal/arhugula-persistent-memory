...
ssh -i $SSH_KEY -p $POD_PORT root@$POD_IP "mkdir -p \
    ...
    /workspace/archive/stale_subdirs/session_logs \
    /workspace/archive/stale_subdirs/session_logs/sub_step_summaries"
...
scp -i $SSH_KEY -P $POD_PORT \
    ...
    root@$POD_IP:/workspace/archive/stale_subdirs/session_logs/session_2_5_summary_block.md
...
for SUB_STEP in 4_0 4_1 4_2 4_5 4_6 4_7 4_8 4_4; do
    scp -i $SSH_KEY -P $POD_PORT \
        ...
        root@$POD_IP:/workspace/archive/stale_subdirs/session_logs/sub_step_summaries/
done
```
...
ssh -i $SSH_KEY -p $POD_PORT root@$POD_IP "
    cd /workspace/archive/stale_subdirs/session_logs
...
ssh -i $SSH_KEY -p $POD_PORT root@$POD_IP "
    df -h /workspace
    ls -la /workspace/architecture_profile/ /workspace/archive/stale_subdirs/session_logs/
"
```
