...
**F1 READINESS SCORECARD (updated 2026-06-26 (C10 widened [4,12] done — NO MATERIAL KNOB RESCUE; D-C10f-band412/CORPUS/38; strength/layer-count and AnyEdit still untested))** — _auto-generated from `docs/program_state.json` — DO NOT edit between the markers; run `python3 tools/render_state.py --write`._
...
- **Robustness:** native-knowing robust IFF no entrenched pretrained competitor (code/structural yes; common-knowledge domain_concepts no); C/G7 multi-token ❌; C10 later-band and widened-band knobs ❌; C2-band ⚠️
